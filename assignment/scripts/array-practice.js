...
let favoriteFoods = ['ice cream', 'cookies', 'cake', 'really big cake'];
...
console.log('I added a food to the end of the array,', favoriteFoods);
...
console.log('Removed the last animal', favoriteFoods);
...
console.log(`I added a new food to the beginning: ${favoriteFoods}`);
...
favoriteFoods.splice(1, 1, 'toast');
